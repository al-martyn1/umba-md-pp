...
MARTY_CPP_ENUM_CLASS_DESERIALIZE_BEGIN( MdPpTag, std::map, 1 )
    ...
    MARTY_CPP_ENUM_CLASS_DESERIALIZE_ITEM( MdPpTag::cliOptList2         , "cli-option-list2"      );
    MARTY_CPP_ENUM_CLASS_DESERIALIZE_ITEM( MdPpTag::cliOptList2         , "cli-opt-list2"         );
    ...
    MARTY_CPP_ENUM_CLASS_DESERIALIZE_ITEM( MdPpTag::cliOptList          , "cli-option-list"       );
    MARTY_CPP_ENUM_CLASS_DESERIALIZE_ITEM( MdPpTag::cliOptList          , "cli-opt-list"          );
