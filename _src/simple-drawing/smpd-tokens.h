...
#define SMPD_TOKEN_OPERATOR_CALLOUT_MAX_NUM_OF                      0x20
//#define SMPD_TOKEN_OPERATOR_CALLOUT_MAX_NUM_OF                      2
#define SMPD_TOKEN_OPERATOR_CALLOUT_RANGE_FIRST_OFFSET(nRange)      ((SMPD_TOKEN_OPERATOR_CALLOUT_MAX_NUM_OF)*((nRange)))
#define SMPD_TOKEN_OPERATOR_CALLOUT_RANGE_LAST_OFFSET(nRange)       ((SMPD_TOKEN_OPERATOR_CALLOUT_MAX_NUM_OF)*((nRange)+1)-1)
...
// ---\  callout влево вверх
#define SMPD_TOKEN_OPERATOR_CALLOUT_TO_LEFT_TOP               (UMBA_TOKENIZER_TOKEN_OPERATOR_USER_FIRST + SMPD_TOKEN_OPERATOR_CALLOUT_RANGE_FIRST_OFFSET(0))
#define SMPD_TOKEN_OPERATOR_CALLOUT_TO_LEFT_TOP_LAST          (UMBA_TOKENIZER_TOKEN_OPERATOR_USER_FIRST +  SMPD_TOKEN_OPERATOR_CALLOUT_RANGE_LAST_OFFSET(0))

// ---/  callout влево вниз
#define SMPD_TOKEN_OPERATOR_CALLOUT_TO_LEFT_BOTTOM            (UMBA_TOKENIZER_TOKEN_OPERATOR_USER_FIRST + SMPD_TOKEN_OPERATOR_CALLOUT_RANGE_FIRST_OFFSET(1))
#define SMPD_TOKEN_OPERATOR_CALLOUT_TO_LEFT_BOTTOM_LAST       (UMBA_TOKENIZER_TOKEN_OPERATOR_USER_FIRST +  SMPD_TOKEN_OPERATOR_CALLOUT_RANGE_LAST_OFFSET(1))

// /---  callout вправо вверх
#define SMPD_TOKEN_OPERATOR_CALLOUT_TO_RIGHT_TOP              (UMBA_TOKENIZER_TOKEN_OPERATOR_USER_FIRST + SMPD_TOKEN_OPERATOR_CALLOUT_RANGE_FIRST_OFFSET(2))
#define SMPD_TOKEN_OPERATOR_CALLOUT_TO_RIGHT_TOP_LAST         (UMBA_TOKENIZER_TOKEN_OPERATOR_USER_FIRST +  SMPD_TOKEN_OPERATOR_CALLOUT_RANGE_LAST_OFFSET(2))

// \---  callout вправо вниз
#define SMPD_TOKEN_OPERATOR_CALLOUT_TO_RIGHT_BOTTOM           (UMBA_TOKENIZER_TOKEN_OPERATOR_USER_FIRST + SMPD_TOKEN_OPERATOR_CALLOUT_RANGE_FIRST_OFFSET(3))
#define SMPD_TOKEN_OPERATOR_CALLOUT_TO_RIGHT_BOTTOM_LAST      (UMBA_TOKENIZER_TOKEN_OPERATOR_USER_FIRST +  SMPD_TOKEN_OPERATOR_CALLOUT_RANGE_LAST_OFFSET(3))

// <--- - горизонтальная налево
#define SMPD_TOKEN_OPERATOR_CALLOUT_TO_LEFT                   (UMBA_TOKENIZER_TOKEN_OPERATOR_USER_FIRST + SMPD_TOKEN_OPERATOR_CALLOUT_RANGE_FIRST_OFFSET(4))
#define SMPD_TOKEN_OPERATOR_CALLOUT_TO_LEFT_LAST              (UMBA_TOKENIZER_TOKEN_OPERATOR_USER_FIRST +  SMPD_TOKEN_OPERATOR_CALLOUT_RANGE_LAST_OFFSET(4))

// ---> - горизонтальная направо
#define SMPD_TOKEN_OPERATOR_CALLOUT_TO_RIGHT                  (UMBA_TOKENIZER_TOKEN_OPERATOR_USER_FIRST + SMPD_TOKEN_OPERATOR_CALLOUT_RANGE_FIRST_OFFSET(5))
#define SMPD_TOKEN_OPERATOR_CALLOUT_TO_RIGHT_LAST             (UMBA_TOKENIZER_TOKEN_OPERATOR_USER_FIRST +  SMPD_TOKEN_OPERATOR_CALLOUT_RANGE_LAST_OFFSET(5))

// ---|^ - вертикальная вверх
#define SMPD_TOKEN_OPERATOR_CALLOUT_TO_TOP                    (UMBA_TOKENIZER_TOKEN_OPERATOR_USER_FIRST + SMPD_TOKEN_OPERATOR_CALLOUT_RANGE_FIRST_OFFSET(6))
#define SMPD_TOKEN_OPERATOR_CALLOUT_TO_TOP_LAST               (UMBA_TOKENIZER_TOKEN_OPERATOR_USER_FIRST +  SMPD_TOKEN_OPERATOR_CALLOUT_RANGE_LAST_OFFSET(6))

// ---| - вертикальная вниз
#define SMPD_TOKEN_OPERATOR_CALLOUT_TO_BOTTOM                 (UMBA_TOKENIZER_TOKEN_OPERATOR_USER_FIRST + SMPD_TOKEN_OPERATOR_CALLOUT_RANGE_FIRST_OFFSET(7))
#define SMPD_TOKEN_OPERATOR_CALLOUT_TO_BOTTOM_LAST            (UMBA_TOKENIZER_TOKEN_OPERATOR_USER_FIRST +  SMPD_TOKEN_OPERATOR_CALLOUT_RANGE_LAST_OFFSET(7))

// .--- - right callout shelf
#define SMPD_TOKEN_OPERATOR_CALLOUT_SHELF_TO_RIGHT            (UMBA_TOKENIZER_TOKEN_OPERATOR_USER_FIRST + SMPD_TOKEN_OPERATOR_CALLOUT_RANGE_FIRST_OFFSET(8))
#define SMPD_TOKEN_OPERATOR_CALLOUT_SHELF_TO_RIGHT_LAST       (UMBA_TOKENIZER_TOKEN_OPERATOR_USER_FIRST +  SMPD_TOKEN_OPERATOR_CALLOUT_RANGE_LAST_OFFSET(8))

// ---. - left callout shelf
#define SMPD_TOKEN_OPERATOR_CALLOUT_SHELF_TO_LEFT             (UMBA_TOKENIZER_TOKEN_OPERATOR_USER_FIRST + SMPD_TOKEN_OPERATOR_CALLOUT_RANGE_FIRST_OFFSET(9))
#define SMPD_TOKEN_OPERATOR_CALLOUT_SHELF_TO_LEFT_LAST        (UMBA_TOKENIZER_TOKEN_OPERATOR_USER_FIRST +  SMPD_TOKEN_OPERATOR_CALLOUT_RANGE_LAST_OFFSET(9))


#define SMPD_TOKEN_OPERATOR_AFTER_CALLOUTS_FIRST              (UMBA_TOKENIZER_TOKEN_OPERATOR_USER_FIRST + SMPD_TOKEN_OPERATOR_CALLOUT_RANGE_FIRST_OFFSET(10))
