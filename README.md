...
#--attr-list-section-title=Attributes
...
#--tag-list-section-title=Tags

--cmd-list-value-style=backtick
#--cmd-list-type=text
 --cmd-list-type=table
--cmd-list-title=:Команда|:Описание
# --cmd-list-title=:Value|:Meaning
--cmd-list-section-title=Команды
#--cmd-list-section-title=Parameters
