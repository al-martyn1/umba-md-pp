...
struct PlantUmlOptions
{
    ...
    //LOG_INFO("plant-uml") << "PlantUML generator configuration"
    void logConfig() const
    {
        LOG_INFO("plant-uml") << "TargetFormat : " << enum_serialize(targetFormat) << "\n";
        LOG_INFO("plant-uml") << "DiagramType  : " << enum_serialize(diagramType) << "\n";
        LOG_INFO("plant-uml") << "Scale (%)    : " << scale << "\n";
        LOG_INFO("plant-uml") << "Filename Autogeneration: " << (useFilenameAutogeneration?"true":"false") << "\n";
        LOG_INFO("plant-uml") << "A/g index    : " << autoGeneratedIndex << "\n";
        LOG_INFO("plant-uml") << "A/g tmp index: " << autoGeneratedTempDotIndex << "\n";
        LOG_INFO("plant-uml") << "Save Filename: " << saveFilename << "\n";
        LOG_INFO("plant-uml") << "Save Path    : " << savePath << "\n";
        LOG_INFO("plant-uml") << "Show Labels  : " << (showLabels?"true":"false") << "\n";
    }
