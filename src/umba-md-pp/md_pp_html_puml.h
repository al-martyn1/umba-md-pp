                                             ...
                                             )
{
    ...
    for(; idx!=tagLines.size(); ++idx)
    {
        ...
        {
            tagLines.insert(tagLines.begin()+insertPos, "' Autogenerated Index: " + autogeneratedIndexStr); 
            ++insertPos;
                        ...
                        )
{
    ...
    auto outputFilename   = plantUmlOptions.generateOutputFilename(appCfg.flattenImageLinks, &autogeneratedIndexStr);
