...
# Известные проблемы и TODO
  ...
  - **Обработка ссылок на внешние документы и картинки**
    ...
    - [ ] Процессинг ссылок/картинок/sup/sub делаем построковый, мало кто индексы и ссылки переносит на несколько строк (если такое вообще можно).
    - [ ] Процессинг ссылок/картинок/sup/sub последовательный - сначала ссылки, потом sup/sub, потом, если ещё какие-то фичи, то они будут доваляться в пайплайн, 
          а не встраиваться в один автомат. Это дольше, ну и пофик, зато проще.
