...
# TODO List
  ...
  - **Графы (DOT)**
    ...
    - [ ] разбор атрибутов HTML-тэгов в кавычках вроде добавил, но вроде есть баги
    ...
    - [ ] Атрибут `type` вроде добил enum'ов, но разные graphviz-тулзы пока не вызываются по этому тэгу.
