...
Может задан "путь" - следующие друг за другом сигнатуры кода, разделённые символом '/',
...
По умолчанию мощность павна единице.
...
Данная директива извлечёт три фрагмента т аналогична трём последовательным директивам:
