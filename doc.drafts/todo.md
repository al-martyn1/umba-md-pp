...
- **Директивы UMBA-MD-PP - #!meta - вставка метатегов в документ**
  ...
  - [ ] `#!meta`. Заголовок секции метатегов в документе: "Информация о документе"/"Document Information". Оформляем болдом, а не заголовком.
  ...
  - [ ] `Метатеги`. Нужно добавить фичу макроподстановок в метатегах. Тогда мы задаём в командной строке `DocumentBaseURL`/`BaseURL` и можем его 
